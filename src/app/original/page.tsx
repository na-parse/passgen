  ...
  return (
    <main className="min-h-screen bg-[rgb(33,33,49)] p-8">
      <div className="max-w-2xl w-full mx-auto pt-8 pb-48">
        ...
        {passwords.length === 0 && (
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 text-gray-400 text-sm leading-relaxed space-y-3">
            <p>
              <span className="text-orange-400 font-semibold">Passgen</span> generates cryptographically secure passwords entirely in your browser using the Web Cryptography API. No passwords are ever transmitted to a server or stored remotely.
            </p>
            <p>
              Click <span className="text-orange-400">Generate Password</span> to create a new password, then click any result to copy it to your clipboard. Use the settings panel above to configure password length and character composition requirements.
            </p>
          </div>
        )}
